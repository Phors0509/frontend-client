...
export default function SideBarCom() {
  ...
  return (
    <ScrollArea className={cn("pt-16 h-screen transition-all duration-300 dark:bg-[#1e2746]" , isOpen ? "w-80" : "w-28" )} onMouseEnter={toggleSidebar} onMouseLeave={toggleSidebar}>
